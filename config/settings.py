...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-&f3=^befo(%sk#m#!5fu)zfv42+$p85mgj(dxixk(dbedtc=1b')
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'books.context_processors.cart_dropdown',
            ],
        },
    },
]
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('DB_NAME', 'northshore_books'),
        'USER': os.getenv('DB_USER', 'root'),
        'PASSWORD': os.getenv('DB_PASSWORD', 'msqMyf4tcAt1!'),
